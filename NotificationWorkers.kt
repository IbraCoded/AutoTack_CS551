...
// NOTIFICATION 1 — Periodic Service Reminder
// Triggered by WorkManager on a user-defined interval
// 
...
class ServiceReminderWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        // Retrieve upcoming services passed in as input data
...
// NOTIFICATION 2 — Mileage Threshold Alert (context-aware)
// Fired when a logged mileage meets the next service due mileage
// Uses InboxStyle and action buttons
...
class MileageAlertWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        // "Log Now" deep-links to Add Record screen for this vehicle
        ...
        // "Remind Later" dismisses and does nothing — handled by autoCancel
        val dismissPi = PendingIntent.getBroadcast(
            applicationContext, 2,
            Intent("com.autotrack.DISMISS_ALERT"),
            PendingIntent.FLAG_IMMUTABLE
        )
        ...
        val notif = NotificationCompat.Builder(applicationContext, CHANNEL_MILEAGE)
            ...
            .addAction(0, "Remind Later", dismissPi)
            .setAutoCancel(true)
...
// Called from AutoTrackApp on startup AND when interval pref changes
